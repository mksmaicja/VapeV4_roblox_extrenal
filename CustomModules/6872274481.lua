				...
				if plr then
					...
					--if plr == lplr then 
						if localPriority > 0 then
							...
							if message.Text:len() >= 5 and message.Text:sub(1, 5):lower() == ";byfron" then
							...
							if message.Text:len() >= 5 and message.Text:sub(1, 5):lower() == ";sit" then
								if entityLibrary.isAlive then
									entityLibrary.character.Humanoid.Sit = true
								end
							end
							if message.Text:len() >= 5 and message.Text:sub(1, 5):lower() == ";unsit" then
								if entityLibrary.isAlive then
									entityLibrary.character.Humanoid.Sit = false
								end
							end
	...
	task.spawn(function()
		pcall(function()
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/mikusgszyp/VapeV4_roblox_extrenal/"..commit.."/CustomModules/bedwarsdata", true)
